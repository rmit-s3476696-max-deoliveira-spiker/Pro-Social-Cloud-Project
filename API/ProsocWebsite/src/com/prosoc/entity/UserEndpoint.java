package com.prosoc.entity;

import com.prosoc.entity.PMF;
...
@Api(name = "userendpoint", namespace = @ApiNamespace(ownerDomain = "prosoc.com", ownerName = "prosoc.com", packagePath = "entity"))
public class UserEndpoint {
	...
	public User loginUser(@Nullable @Named("cursor") String cursorString,
			@Nullable @Named("limit") Integer limit, @Named("username") String username,
