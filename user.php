<?php 
    ...
    if(isset($_POST["resultName"]) && isset($_POST["resultUserName"])
      && isset($_POST["resultEmail"]) && isset($_POST["resultPhone"])){
     $_SESSION["resultName"] = $_POST["resultName"];
     $_SESSION["resultUserName"] = $_POST["resultUserName"];
     $_SESSION["resultEmail"] = $_POST["resultEmail"];
     $_SESSION["resultPhone"] = $_POST["resultPhone"];
     }
    ...
    $eventRecord = "gs://prosoc-storage/UserEvents/". $_SESSION['getUserByEmail'] . ".csv";
    $options = [
        'Content-Type' => 'binary/octet-stream',
    ];
    $context = stream_context_create(['gs' => $options]);
		$events = fopen($eventRecord,'w',0,$context) or die("Can't open file");
		
		$getEvents = explode("\n",file_get_contents($eventRecord));
...
<html class="html" lang="en-US">
 ...
 <!--<script type="text/javascript">
  ...
  <link rel="stylesheet" type="text/css" href="css/user.css?117705652" id="pagesheet"/>
  <script>
      function initMap() {
  ...
  <div class="clearfix" id="page"><!-- column -->
   <div class="position_content" id="page_position_content">
    ...
    <div class="clearfix colelem" id="u223-4"><!-- content -->
     <p id="u223-2">
	 <?php 
		echo "Welcome " . $_SESSION['resultUserName'];
	 ?>
	 </p>
    </div>
    <div class="clearfix colelem" id="pu229-4"><!-- group -->
     <div class="clearfix grpelem" id="u229-4"><!-- content -->
      <p><img src="images/profile.jpg" width="126" height="214" /></p>
     </div>
     <div class="clearfix grpelem" id="u1134-13"><!-- content -->
      <p>Full Name: <?php echo $_SESSION["resultName"] ?></p>
      <p>&nbsp;</p>
      <p>Email: <?php echo $_SESSION["resultEmail"] ?></p>
      <p>&nbsp;</p>
      <p>Phone: <?php echo $_SESSION["resultPhone"] ?></p>
      <p>&nbsp;</p>
     </div>
    </div>
    ...
    <div class="clearfix colelem" id="pu1124"><!-- group -->
     ...
     <div class="clearfix grpelem" id="u1124"><!-- column -->
      <div class="clearfix colelem" id="pu230-5"><!-- group -->
       <div class="clearfix grpelem" id="u230-5"><!-- content -->
        <p id="u230-2">Select file to upload:</p>
        <p>&nbsp;</p>
       </div>
      </div>
      <div class="clearfix colelem" id="u1130-4"><!-- content -->
       <p><input type="file" name="fileToUpload"></p>
      </div>
      <div class="Button rounded-corners clearfix colelem" id="buttonu1126"><!-- container box -->
    ...
    <div class="clearfix colelem" id="pu1119-4"><!-- group -->
    ...
    <div class="clearfix colelem" id="pu1116"><!-- group -->
     ...
     <!--<div class="clearfix grpelem" id="u1133-23"><!-- content 
       <p id="u1133-2">File 1</p>
       <p id="u1133-3">&nbsp;</p>
       <p id="u1133-5">File 2</p>
       <p id="u1133-6">&nbsp;</p>
       <p id="u1133-8">File 3</p>
       <p id="u1133-9">&nbsp;</p>
       <p id="u1133-11">File 4</p>
       <p id="u1133-12">&nbsp;</p>
       <p id="u1133-14">File 5</p>
       <p id="u1133-15">&nbsp;</p>
       <p id="u1133-16">&nbsp;</p>
       <p id="u1133-17">&nbsp;</p>
       <p id="u1133-18">&nbsp;</p>
    ...
    <?php
    $getFiles = explode("\n",file_get_contents('gs://prosoc-storage/UserFiles/'. $_SESSION['getUserByEmail'] . '.csv'));
    $arrlength=count($getFiles);
    for($x=1;$x<$arrlength;$x++)
    {
      $arr = explode(",", $getFiles[$x]);
      echo "<tr><td style='border: 1px solid black; padding: 5px; font-weight:normal;'>"
      .$arr[0]."</td><td style='border: 1px solid black; padding: 5px; font-weight:normal;'>
      <img src='".$arr[1]."' /></td><td id='location".$x."' style='border: 1px solid black; padding: 5px; font-weight:normal;'>"
      .$arr[2]."</td><td style='border: 1px solid black; padding: 5px; font-weight:normal;'><a href="
      .$arr[3]." target='_blank'><button>Open</button></a><br><a href="
      .$arr[3]." download=".$arr[0]."><button>Download</button></a></td></tr>";
    }
     ?>
    </table>
    <p id="u1118-15">&nbsp;</p>
    <p id="u1118-15">&nbsp;</p>
      <p id="u1118-15">Total No. Of Files: </p>
    <p id="u1118-14"><?php echo $arrlength-1; ?></p>
      <p id="u1118-16">&nbsp;</p>
     </div>
    </div>
